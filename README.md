...
Skills covered in this program : **`Python`**, **`VectorDB`**, **`NLP`**, **`GitHub`**, **`LangChain`**, **`Transformers`**.

<center> <h2 style= "color:orange"> Course Curriculum </h2> </center>

<center> <h3 style= "color:green"> 1. Introduction to Generative AI </h3> </center>
...
<center> <h3 style= "color:green"> 3. Introduction to Large Language Models </h3> </center>

1. **Transfer learning in NLP**
2. **How to use pre-trained transformer-based models**
3. **How to perform finetuning of pre trained transformer based models**
4. **Mask language modeling**
5. **BERT- Google**
6. **GPT- OpenAI**
7. **T5- Google**
8. **Megatron- NVIDIA**
9. **Evaluations Matrixs of LLMs models**
10. **GPT-3 and 3.5 Turbo use cases**
11. **Learn how Chatgpt trained**
12. **Introduction to Chatgpt- 4**

<center> <h3 style= "color:green"> 4. Introduction to Huggingface And its Applications </h3> </center>
...
<center> <h3 style= "color:green"> 5. Generative AI with LLMs and LLM Powered Applications </h3> </center>
...
<center> <h3 style= "color:green"> 6. Guide to Open AI and its Ready to Use Models with Application </h3> </center>
...
<center> <h3 style= "color:green"> 7. Prompt Engineering Mastering with OpenAI </h3> </center>
...
22. **Super Prompts Like CAN & DAN**

<center> <h3 style= "color:green"> 8. Vector database with Python for LLM Use Cases </h3> </center>
...
<center> <h3 style= "color:green"> 9. Hands-on with LangChain </h3> </center>
...
<center> <h3 style= "color:green"> 10. Hands on with LangChain </h3> </center>
...
<center> <h3 style= "color:green"> 11. Practical Guide to LlamaIndex with LLMs </h3> </center>
...
<center> <h3 style= "color:green"> 12. End to End Projects </h3> </center>
